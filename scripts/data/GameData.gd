...
const CARGO_PIECE_SETS := {
	...
	"space_shuttle": [
		...
		},
		{
			...
			"cells": [Vector2i(0, 0), Vector2i(1, 0), Vector2i(0, 1), Vector2i(1, 1), Vector2i(1, 2)],
			"copies": 2,
		},
		{
			"id": "ss_l_block_4",
			"display_name": "L Block",
			"cells": [Vector2i(0, 0), Vector2i(1, 0), Vector2i(0, 1), Vector2i(0, 2)],
			"copies": 2,
		},
		{
			"id": "ss_step_block_4",
			"display_name": "Step Block",
			"cells": [Vector2i(1, 0), Vector2i(0, 1), Vector2i(1, 1), Vector2i(0, 2)],
			"copies": 2,
		},
		{
			"id": "ss_corner_block_3",
			"display_name": "Corner Block",
			"cells": [Vector2i(1, 0), Vector2i(0, 1), Vector2i(1, 1)],
			"copies": 2,
		},
	],
	"spinlaunch": [
